...
let exportedMethods = {
    ...
    async addEvent(weddingId, title, date, description) {
        ...
        const updatedWedding = {
            ...wedding,
            events: [...wedding.events, { _id: ObjectId(), title, date, description }],
        };
    ...
    async removeEvent(weddingId, eventId) {
        ...
        const updatedWedding = {
            ...wedding,
            events: wedding.events.filter((event) => event._id.toString() !== eventId),
        };
    ...
    async updateWedding({ weddingId, venue, title, events, date, contactPerson, rsvpDeadline }) {
        if (venue) {
